  ...
  return (
    <div className="bg-bgcolorless min-h-screen mb-20 h-fit max-w-full">
      <div className="w-full flex lg:flex-row flex-col gap-x-10">
        {/* Left Section */}
        <div className="order-2 lg:order-1 flex-1 lg:m-3 mt-0 m-3">
        ...
        {/* Right Section */}
        <BeamCollision className="p-[70px_7px] order-1 lg:order-2 bg-bgcolorless flex-1 w-full flex flex-col items-center justify-center text-center">
