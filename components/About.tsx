...
<div className="bg-bgcolorless min-h-screen mb-20 h-fit max-w-full">
  <div className="h-screen w-full flex md:flex-row flex-col gap-10">
    <div className="order-2 md:order-1 flex-1 h-full m-3">
      <div className="relative h-fit rounded-3xl md:p-8 p-0 border border-bordercolor/20 bg-white/10 backdrop-blur-2xl shadow-2xl overflow-hidden">
