    ...
    <div className="relative">
      ...
      <div className="w-full h-fit min-h-screen flex flex-wrap md:flex-nowrap justify-center md:justify-between sm:px-[8vw] px-[7px] items-center gap-x-17 sm:pb-0 pb-10 mt-10">
        ...
        <div className="z-1 mr-0 md:mr-6 lg:mr-0 h-[500px] sm:w-full md:w-[35%] lg:w-fit md:mt-[-200px] mt-[50px] mb-[50px] flex flex-col items-center gap-2">
          <div className="glow-fade-in relative top-25 bg-gradient-to-r dark:from-cyan-800 dark:to-emerald-800 from-cyan-200 to-emerald-200 rounded-full p-10 blur-2xl">
