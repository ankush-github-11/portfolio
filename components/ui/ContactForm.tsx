      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 rounded-lg border-2 border-gray/50 dark:border-gray/35 outline-none focus:border-emerald-300 dark:focus:border-emerald-700"
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={4}
            className="w-full px-4 py-2 rounded-lg border-2 border-gray/50 dark:border-gray/35 focus:border-emerald-300 dark:focus:border-emerald-700 outline-none"
