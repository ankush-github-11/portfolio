...
const SkillsCard : React.FC<SkillsCardProps> = ({children, height, width, title}) => {
  return (
      <div className="btn-donate relative overflow-hidden flex flex-col">
        ...
        <svg viewBox="0 0 128 128" height={height} width={width}   className="text-textcolor [&_*]:fill-current [&_*]:stroke-current flex justify-center relative">
          {children}
        </svg>
